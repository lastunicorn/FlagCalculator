...
namespace DustInTheWind.FlagCalculator.UI.Commands
{
    internal class ToggleDisplaySelectedCommand : CommandBase
    {
        ...
        public ToggleDisplaySelectedCommand(UserInterface userInterface, OpenedProjects openedProjects)
            : base(userInterface)
        {
        ...
        public ToggleDisplaySelectedCommand(UserInterface userInterface, ProjectContext projectContext)
            : base(userInterface)
        {
        ...
        {
            projectContext.ToggleDisplaySelected();
        }
    }
}